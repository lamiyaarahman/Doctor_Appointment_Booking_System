...
const SpecialityMenu = () => {
  return (
    <div className='flex flex-col items-center gap-4 py-16 text-gray-800' id="speciality">
        <h1 className='text-3xl font-medium'>Locate by Speciality</h1>
        <p className='sm:w-1/3 text-center text-sm'>We’ve served our community with trust, kindness and understanding. We providers offering comprehensive, specialized care for you and your family.</p>
